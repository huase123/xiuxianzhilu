...
public class ChangeLingxiuTrigger extends SimpleCriterionTrigger<ChangeLingxiuTrigger.TriggerInstance> {
    static final ResourceLocation ID = ModMain.prefix("changelingxiutrigger");
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance {
        ...
        public TriggerInstance(ContextAwarePredicate p_286423_, ResourceLocation resourceKey) {
            super(ChangeLingxiuTrigger.ID, p_286423_);
            this.resourceKey = resourceKey;
        }


        public static TriggerInstance createInstance(ResourceKey<LingxiuJingjieSample> resourceKey) {
