...
public class LianqidingCategory implements IRecipeCategory<LianqidingRecipe> {
    public static final ResourceLocation UID = ModMain.prefix("jei_pot");
    public static final ResourceLocation TEXTURE = ModMain.prefix("textures/gui/pot/potdisplayer.png");

    public static final RecipeType<LianqidingRecipe> GEM_POLISHING_TYPE =
            new RecipeType<>(UID, LianqidingRecipe.class);

    private final IDrawable background;
    private final IDrawable icon;

    public LianqidingCategory(IGuiHelper helper) {
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(BlockInit.jvlingzhen.get()));
    }
    ...
    public void draw(LianqidingRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
        ...
        guiGraphics.drawString(Minecraft.getInstance().font,
                Component.translatable("所需能量",recipe.getLingli())
