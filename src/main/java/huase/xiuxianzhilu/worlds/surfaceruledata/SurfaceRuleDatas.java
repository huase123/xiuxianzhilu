package huase.xiuxianzhilu.worlds.surfaceruledata;
...
/**
 * - @description:SurfaceRuleDatas类
 */
public class SurfaceRuleDatas {
    ...
    private static final SurfaceRules.RuleSource WHITE_WOOL = makeStateRule(Blocks.WHITE_WOOL);
    private static final SurfaceRules.RuleSource BLACK_WOOL = makeStateRule(Blocks.BLACK_WOOL);
    private static final SurfaceRules.RuleSource BLUE_WOOL = makeStateRule(Blocks.BLUE_WOOL);
    private static final SurfaceRules.RuleSource CYAN_WOOL = makeStateRule(Blocks.CYAN_WOOL);
    private static final SurfaceRules.RuleSource GREEN_WOOL = makeStateRule(Blocks.GREEN_WOOL);
    private static final SurfaceRules.RuleSource LIME_WOOL = makeStateRule(Blocks.LIME_WOOL);
    ...
    public static SurfaceRules.RuleSource xiuxianjieLike() {
        ...
        SurfaceRules.RuleSource surfacerules$rulesource1 = SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, SANDSTONE), SAND);
        ...
        SurfaceRules.RuleSource surfacerules$rulesource8 = SurfaceRules.sequence(
                ...
                SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.BADLANDS, Biomes.ERODED_BADLANDS, Biomes.WOODED_BADLANDS),
                        SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, SurfaceRules.sequence(SurfaceRules.ifTrue(surfacerules$conditionsource1, ORANGE_TERRACOTTA),
                                SurfaceRules.ifTrue(surfacerules$conditionsource3, SurfaceRules.sequence(SurfaceRules.ifTrue(surfacerules$conditionsource15, TERRACOTTA),
                                        SurfaceRules.ifTrue(surfacerules$conditionsource16, TERRACOTTA), SurfaceRules.ifTrue(surfacerules$conditionsource17, TERRACOTTA),
                                        SurfaceRules.bandlands())), SurfaceRules.ifTrue(surfacerules$conditionsource7, SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.ON_CEILING, RED_SANDSTONE), RED_SAND)),
                ...
                SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, SurfaceRules.ifTrue(surfacerules$conditionsource7, SurfaceRules.sequence(SurfaceRules.ifTrue(surfacerules$conditionsource11,
                ...
                SurfaceRules.ifTrue(surfacerules$conditionsource9, SurfaceRules.sequence(
                        SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, SurfaceRules.ifTrue(surfacerules$conditionsource11, SurfaceRules.ifTrue(surfacerules$conditionsource10, WATER))),
                ...
                SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.FROZEN_PEAKS, Biomes.JAGGED_PEAKS), STONE),
        ...
        SurfaceRules.RuleSource grass_block_surfacerules =
        ...
        ;
        SurfaceRules.RuleSource deepslate_surfacerules =
                SurfaceRules.ifTrue(SurfaceRules.DEEP_UNDER_FLOOR,
                    SurfaceRules.sequence(
                    SurfaceRules.ifTrue(SurfaceRules.waterBlockCheck(0, 0), DEEPSLATE),
                            CALCITE)
                )
        ;

        SurfaceRules.RuleSource air_surfacerules =
                SurfaceRules.ifTrue(SurfaceRules.DEEP_UNDER_FLOOR,
                        SurfaceRules.sequence(
                                AIR
                        )
                ...
                ;
        SurfaceRules.RuleSource sand_surfacerules =
                    SurfaceRules.sequence(
                            SurfaceRules.ifTrue(SurfaceRules.DEEP_UNDER_FLOOR,
                                    SAND
                            ),
        ...
        SurfaceRules.RuleSource podzol_surfacerules =
                    SurfaceRules.sequence(
                            SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR,
                                    PODZOL
                            ),
        ...
        SurfaceRules.RuleSource snow_surfacerules =
                    SurfaceRules.sequence(
                            SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR,
                                    SNOW_BLOCK
                            ),
...
//                                河流
                                SurfaceRules.ifTrue(
                                        SurfaceRules.isBiome(BiomesInit.xiuxianjie_biome0),
                                        SurfaceRules.sequence(
                                                grass_block_surfacerules
                                        )
                                )
//                                草原
                                ,SurfaceRules.ifTrue(
                                        SurfaceRules.isBiome(BiomesInit.xiuxianjie_biome1),
                                        SurfaceRules.sequence(
                                                grass_block_surfacerules
                                        )
                                )
//                                山地
                                ,SurfaceRules.ifTrue(
                                        SurfaceRules.isBiome(BiomesInit.xiuxianjie_biome2),
                                        SurfaceRules.sequence(
                                                grass_block_surfacerules
                                        )
                                )
//                                地下
                                ,SurfaceRules.ifTrue(
                                        SurfaceRules.isBiome(BiomesInit.xiuxianjie_biome3),
                                        SurfaceRules.sequence(
                                                air_surfacerules
                                        )
                                )
//                                沙漠
                                ,SurfaceRules.ifTrue(
                                        SurfaceRules.isBiome(BiomesInit.xiuxianjie_biome4),
                                        SurfaceRules.sequence(
                                                sand_surfacerules
                                        )
                                )
//                                森林
                                ,SurfaceRules.ifTrue(
                                        SurfaceRules.isBiome(BiomesInit.xiuxianjie_biome5),
                                        SurfaceRules.sequence(
                                                podzol_surfacerules
                                        )
                                )
...
//                                火山
                                ,SurfaceRules.ifTrue(
                                        SurfaceRules.isBiome(BiomesInit.xiuxianjie_biome7),
                                        SurfaceRules.sequence(
                                                volcano_surfacerules
                                        )
                                )
//                                雪山
                                ,SurfaceRules.ifTrue(
                                        SurfaceRules.isBiome(BiomesInit.xiuxianjie_biome8),
                                        SurfaceRules.sequence(
                                                snow_surfacerules
                                        )
                                )
...
//                                深海
        ...
        return SurfaceRules.sequence(builder.build().toArray(p_198379_ -> new SurfaceRules.RuleSource[p_198379_]));
    }
