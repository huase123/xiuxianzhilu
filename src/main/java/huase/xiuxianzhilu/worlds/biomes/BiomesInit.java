...
public class BiomesInit {
    ...
    public static void bootstrap(BootstapContext<Biome> context) {
        ...
        context.register(xiuxianjie_biome0 , biomeWithDefaults(0.5f,0.0f,fireflyParticles  (defaultSHAmbientBuilder(0x0111fd4e)), defaultSpawning().addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityInit.chilingshuishe .get(), 5, 1, 1)).addMobCharge(EntityInit.chilingshuishe .get(), 0.3D, 0.05D), xiuxianjie_biome0_Placement(featureGetter, carverGetter)).build());
        context.register(xiuxianjie_biome1 , biomeWithDefaults(0.5f,0.1f,fireflyParticles  (defaultSHAmbientBuilder(0x0211cd4e)), defaultSpawning().addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityInit.huanlinghu     .get(), 5, 1, 1)).addMobCharge(EntityInit.huanlinghu     .get(), 0.3D, 0.05D), xiuxianjie_biome1_Placement(featureGetter, carverGetter)).build());
        context.register(xiuxianjie_biome2 , biomeWithDefaults(0.5f,0.5f,fireflyParticles  (defaultSHAmbientBuilder(0x0311ad4e)), defaultSpawning().addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityInit.xueyichanglang .get(), 5, 1, 1)).addMobCharge(EntityInit.xueyichanglang .get(), 0.3D, 0.05D), xiuxianjie_biome2_Placement(featureGetter, carverGetter)).build());
        context.register(xiuxianjie_biome3 , biomeWithDefaults(0.5f,0.0f,fireflyParticles  (defaultSHAmbientBuilder(0xffffffff)), defaultSpawning().addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityInit.youmingguishou .get(), 5, 1, 1)).addMobCharge(EntityInit.youmingguishou .get(), 0.3D, 0.05D), xiuxianjie_biome3_Placement(featureGetter, carverGetter)).build());
        context.register(xiuxianjie_biome4 , biomeWithDefaults(0.5f,0.2f,fireflyParticles  (defaultSHAmbientBuilder(0x0161cd6e)), defaultSpawning().addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityInit.shayingmoxie   .get(), 5, 1, 1)).addMobCharge(EntityInit.shayingmoxie   .get(), 0.3D, 0.05D), xiuxianjie_biome4_Placement(featureGetter, carverGetter)).build());
        context.register(xiuxianjie_biome5 , biomeWithDefaults(0.5f,0.2f,fireflyParticles  (defaultSHAmbientBuilder(0x0141fd1e)), defaultSpawning().addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityInit.huanduzhu      .get(), 5, 1, 1)).addMobCharge(EntityInit.huanduzhu      .get(), 0.3D, 0.05D), xiuxianjie_biome5_Placement(featureGetter, carverGetter)).build());
        context.register(xiuxianjie_biome6 , biomeWithDefaults(0.5f,0.0f,fireflyParticles  (defaultSHAmbientBuilder(0x01111199)), defaultSpawning().addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityInit.zuoying        .get(), 5, 1, 1)).addMobCharge(EntityInit.zuoying        .get(), 0.3D, 0.05D), xiuxianjie_biome6_Placement(featureGetter, carverGetter)).build());
        context.register(xiuxianjie_biome7 , biomeWithDefaults(0.5f,0.5f,fireflyParticles  (defaultSHAmbientBuilder(0x55ff1111)), defaultSpawning().addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityInit.huoqiling      .get(), 5, 1, 1)).addMobCharge(EntityInit.huoqiling      .get(), 0.3D, 0.05D), xiuxianjie_biome7_Placement(featureGetter, carverGetter)).build());
        context.register(xiuxianjie_biome8 , biomeWithDefaults(-2.0f,0.5f,fireflyParticles  (defaultSHAmbientBuilder(0x55999999)),defaultSpawning().addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityInit.xvanbingjvxiong.get(), 5, 1, 1)).addMobCharge(EntityInit.xvanbingjvxiong.get(), 0.3D, 0.05D), xiuxianjie_biome8_Placement(featureGetter, carverGetter)).build());
        context.register(xiuxianjie_biome9 , biomeWithDefaults(-2.0f,2.5f,fireflyParticles  (defaultSHAmbientBuilder(0x55111199)),defaultSpawning().addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityInit.bingfenghuang  .get(), 5, 1, 1)).addMobCharge(EntityInit.bingfenghuang  .get(), 0.3D, 0.05D), xiuxianjie_biome9_Placement(featureGetter, carverGetter)).build());
        context.register(xiuxianjie_biome10, biomeWithDefaults(0.5f,0.0f,fireflyParticles  (defaultSHAmbientBuilder(0x11111133)), defaultSpawning().addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityInit.kunpeng        .get(), 5, 1, 1)).addMobCharge(EntityInit.kunpeng        .get(), 0.3D, 0.05D), xiuxianjie_biome10_Placement(featureGetter, carverGetter)).build());
