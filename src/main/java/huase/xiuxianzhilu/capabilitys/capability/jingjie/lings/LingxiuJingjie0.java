...
public class LingxiuJingjie0 extends LingxiuJingjie {
    ...
    public LingxiuJingjie0(int maxDengji,int intensity,float maxlingli, float maxjingyan, float getWugong, float getWufang, float getMaxshengming, float getBaojishanghai, float getBaojilv) {
        super(maxDengji,intensity,maxlingli, maxjingyan, getWugong, getWufang, getMaxshengming, getBaojishanghai, getBaojilv);
    }
