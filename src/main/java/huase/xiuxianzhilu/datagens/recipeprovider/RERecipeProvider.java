...
//        丹药
        ...
        pWriter.accept(BuildLianqidingRecipe.shapedResult(Iteminit.jiezhi2          .get(), 1).defineLingli(240 ).defineLingliDensity(80    ).defines(Iteminit.xvantie2.get(),1,3,7,9,10,11,14,15,16).defines(Iteminit.lingjin2.get(),2,4,6,8,12,13,18,19,20,21).defines(Iteminit.linghe2 .get(),5));
        pWriter.accept(BuildLianqidingRecipe.shapedResult(Iteminit.jiezhi3          .get(), 1).defineLingli(480 ).defineLingliDensity(120   ).defines(Iteminit.xvantie3.get(),1,3,7,9,10,11,14,15,16,22,23).defines(Iteminit.lingjin3.get(),2,4,6,8,12,13,18,19,20,21,24,25).defines(Iteminit.linghe3 .get(),5));
        ...
        pWriter.accept(BuildLianqidingRecipe.shapedResult(Iteminit.xianglian2       .get(), 1).defineLingli(240 ).defineLingliDensity(80    ).defines(Iteminit.xvantie2.get(),1,3,10,11,14,15,16).defines(Iteminit.lingjin2.get(),7,9,12,13,18,19,20).defines(Iteminit.lingyv2 .get(),2,4,6,8).defines(Iteminit.linghe2 .get(),5));
        pWriter.accept(BuildLianqidingRecipe.shapedResult(Iteminit.xianglian3       .get(), 1).defineLingli(480 ).defineLingliDensity(120   ).defines(Iteminit.xvantie3.get(),1,3,10,11,14,15,16,22,23).defines(Iteminit.lingjin3.get(),7,9,12,13,18,19,20,24,25).defines(Iteminit.lingyv3 .get(),2,4,6,8).defines(Iteminit.linghe3 .get(),5));
        ...
        pWriter.accept(BuildLianqidingRecipe.shapedResult(Iteminit.yvpei2           .get(), 1).defineLingli(240 ).defineLingliDensity(80    ).defines(Iteminit.lingjin2.get(),1,3,7,9,10,11,14,15,16).defines(Iteminit.lingyv2 .get(),2,4,6,8,12,13,18,19,20).defines(Iteminit.linghe2 .get(),5));
        pWriter.accept(BuildLianqidingRecipe.shapedResult(Iteminit.yvpei3           .get(), 1).defineLingli(480 ).defineLingliDensity(120   ).defines(Iteminit.lingjin3.get(),1,3,7,9,10,11,14,15,16,22,23).defines(Iteminit.lingyv3 .get(),2,4,6,8,12,13,18,19,20,24,25).defines(Iteminit.linghe3 .get(),5));
        ...
        pWriter.accept(BuildLianqidingRecipe.shapedResult(Iteminit.hufu2            .get(), 1).defineLingli(240 ).defineLingliDensity(80    ).defines(Iteminit.lingjin2.get(),1,3,7,9,10,11,14,15,16).defines(Iteminit.lingmu2 .get(),2,4,6,8,12,13,18,19,20).defines(Iteminit.linghe2 .get(),5));
        pWriter.accept(BuildLianqidingRecipe.shapedResult(Iteminit.hufu3            .get(), 1).defineLingli(480 ).defineLingliDensity(120   ).defines(Iteminit.lingjin3.get(),1,3,7,9,10,11,14,15,16,22,23).defines(Iteminit.lingmu3 .get(),2,4,6,8,12,13,18,19,20,24,25).defines(Iteminit.linghe3 .get(),5));
